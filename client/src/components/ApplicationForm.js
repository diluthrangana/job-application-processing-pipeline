...
const ApplicationForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://job-application-processing-pipeline-2.onrender.com/api/applications/submit', data, {
        headers: {
      ...
      <div className="form-card">
        ...
        <div className="hosting-notice">
          <p>
            ...
            <a 
              href="https://job-application-processing-pipeline-2.onrender.com/" 
              target="_blank" 
